...
//TEST FÖR TOPRANKADE INLÄGG KATEGORI:ROMANCE 
                    ...
                    function getTopRomance(){                       
                        ...
                        $sql = "SELECT threads.tid FROM threads join ratings on threads.tid = ratings.tid where threads.category = 'Romance'
                    ...
                    elseif($rainy){
                       function getTopRomance(){                       
                            ...
                            $db = new SQLite3('../db/databas.db');     
                            $sql = "SELECT threads.id FROM threads join ratings on threads.tid = ratings.tid where threads.category = 'Romance' 
